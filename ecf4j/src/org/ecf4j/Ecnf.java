...
public class Ecnf {
	...
	/**
	 * Método alinha item de forma a ocupar toda a linha
	...
	/**
	 * Método imprime um item do cupom
	...
	/**
	 * Método imprime uma linha no modo Normal
	 * @param str1 <i>String</i>
	 * @param str2 <i>String</i>
	 * @throws EcnfException Exceção do ECNF
	 * @throws CommException Exceção de comunicação
	...
	/**
	 * Método imprime uma linha tracejada
	 * @throws CommException Exceção de comunicação
	 */
	...
	/**
	 * Método pula determinada quantidade de linhas
	 * @param numLinhas <i>int</i>
	 * @throws CommException Exceção do Ecnf
	 * @throws EcnfException Exceção de comunicação
	 */
