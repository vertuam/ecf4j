...
public class Ecf {
	...
	/**
	 * Método verifica se não ha papel no ECF
	 * @return boolean
	...
	/**
	 * Método busca do ECF o valor de acréscimos da última redução z 
	 * @return BigDecimal - Acréscimos da última Redução Z
	 * @throws CommException Exceção de comunicação
	 * @throws EcfException Exceção do ECF
	 */
	 ...
	 * @return BigDecimal - Valor total de Sangrias da última Redução Z
	 * @throws CommException Exceção de comunicação
	 * @throws EcfException Exceção do ECF
	 */
	 ...
	 * @return BigDecimal - Valor total de Suprimentos da última Redução Z
	 * @throws CommException Exceção de comunicação
	 * @throws EcfException Exceção do ECF
	 */
	...
	/**
	 * Método busca no ECF o Contador de Reinicios de Operação registrado na última redução z
	 * @return int - CRO registrado na última Redução Z
	 * @throws CommException Excção de comunicação
	 * @throws EcfException Exceção do ECF
	 */
	...
	/**
	 * Método busca no ECF o totalizador parcial de Acréscimos
	 * @return BigDecimal - Totalizador de Acréscimos
	 * @throws CommException Exceção de comunicação
	 * @throws EcfException Exceção do ECF
	 */
	...
	/**
	 * Método busca no ECF o totalizador parcial de cancelamentos com incidência em serviços
	...
	/**
	 * Método busca no ECF o totalizador parcial de cancelamentos com incidência em produtos
	...
	/**
	 * Método busca no ECF o totalizador parcial de descontos com incidência em serviços
	...
	/**
	 * Método busca no ECF o totalizador parcial de descontos com incidência em produtos
	...
	/**
	 * Método busca no ECF o totalizador parcial de acréscimos com incidência em produtos
	 * @return BigDecimal - Totalizador de Acréscimos ICMS
	 * @throws CommException Exceção de comunicação
	 * @throws EcfException Exceção do ECF
	 */
	...
	/**
	 * Método busca no ECF o totalizador parcial de acréscimos com incidência em serviços
	 * @return BigDecimal - Totalizador de Acréscimos ISS
	 * @throws CommException Exceção de comunicação
	 * @throws EcfException Exceção do ECF
	 */
