 ...
 */
package org.ecf4j.utils.integers;

import org.ecf4j.utils.bytes.ByteUtils;

/**
 * Classe de tratamento para Integer
 * @author Pablo Fassina e Agner Munhoz
 * @version 1.0.0
 */
public class IntegerUtils {

	public static String intToStr(int valor, int len){
		String result = ""+valor;
	...
	public static int bcdToInt(byte[] b){
		...
		return Integer.parseInt((hexval.toString()));
