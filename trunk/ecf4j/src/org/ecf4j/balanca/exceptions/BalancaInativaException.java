 ...
 */
package org.ecf4j.balanca.exceptions;

import org.ecf4j.utils.i18n.MessagesI18n;

/**
 * Classe de exceções da balança
 * @author Pablo Fassina e Agner Munhoz
 * @version 1.0.0
 * @extends Exception
 */
public class BalancaInativaException extends Exception {
	...
	public BalancaInativaException(){
		super(MessagesI18n.BUNDLE.getString("erroBalancaInativaException"));
	}
	
	public BalancaInativaException(String message, Throwable cause) {
		super(message, cause);
	}

	public BalancaInativaException(String message) {
		super(message);
	}

	public BalancaInativaException(Throwable cause) {
		super(cause);
	}
